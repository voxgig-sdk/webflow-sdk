...
from webflow_sdk.utility import register

# Load features
from webflow_sdk.feature.base_feature import WebflowBaseFeature
from webflow_sdk.features import _has_feature, _make_feature
...
class WebflowSDK:
    ...
    def get_utility(self):
        return WebflowUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WebflowSDK: graphql: " + str(msg))
            res["graphql"] = errors
