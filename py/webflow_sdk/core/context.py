...
from webflow_sdk.core.control import WebflowControl
...
from webflow_sdk.core.helpers import get_ctx_prop, to_map
...
class WebflowContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, WebflowResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return WebflowError(code, msg, self)
