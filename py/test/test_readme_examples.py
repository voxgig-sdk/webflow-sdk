# Webflow SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WebflowSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WebflowSDK(...) and WebflowSDK.test(...) become
#      WebflowSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "webflow_sdk"
_SDK_CLASS = "WebflowSDK"
