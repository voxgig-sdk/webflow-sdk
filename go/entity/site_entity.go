...
import (
	...
	vs "github.com/voxgig-sdk/webflow-sdk/go/utility/struct"
)

type SiteEntity struct {
	name    string
	client  *core.WebflowSDK
...
func NewSiteEntity(client *core.WebflowSDK, entopts map[string]any) *SiteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SiteEntity) GetName() string { return e.name }
...
func (e *SiteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SiteEntity) Deleted() bool {
	return e.deleted
}


func (e *SiteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSiteEntity(e.client, opts)
}

func (e *SiteEntity) Data(args ...any) any {
...
func (e *SiteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Site; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SiteEntity) DataTyped(data ...Site) Site {
	if len(data) > 0 {
		return typedFrom[Site](e.Data(asMap(data[0])))
	}
	return typedFrom[Site](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Site (all fields
// optional at the wire level).
func (e *SiteEntity) MatchTyped(match ...Site) Site {
	if len(match) > 0 {
		return typedFrom[Site](e.Match(asMap(match[0])))
	}
	return typedFrom[Site](e.Match())
}
...
func (e *SiteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SiteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SiteLoadMatch and returns an Site. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SiteEntity) LoadTyped(reqmatch SiteLoadMatch, ctrl map[string]any) (Site, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Site{}, err
	}
	return typedFrom[Site](res), nil
}




func (e *SiteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SiteListMatch and returns []Site. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SiteEntity) ListTyped(reqmatch SiteListMatch, ctrl map[string]any) ([]Site, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Site](res), nil
}



func (e *SiteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SiteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SiteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SiteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
