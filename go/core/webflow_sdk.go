...
func (sdk *WebflowSDK) OptionsMap() map[string]any {
...
func (sdk *WebflowSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WebflowSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WebflowSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WebflowSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WebflowSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WebflowSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WebflowSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WebflowSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WebflowSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WebflowSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *WebflowSDK) Collection(data map[string]any) WebflowEntity {
...
func (sdk *WebflowSDK) Item(data map[string]any) WebflowEntity {
...
func (sdk *WebflowSDK) Site(data map[string]any) WebflowEntity {
