...
// Webflow SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WebflowMakeRequest
{
    public static function call(WebflowContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WebflowResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WebflowResponse($fetched);
        } else {
