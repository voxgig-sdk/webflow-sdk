...
class WebflowFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WebflowSDK/1.0)';
    ...
    public static function call(WebflowContext $ctx, string $fullurl, array $fetchdef): array
    {
