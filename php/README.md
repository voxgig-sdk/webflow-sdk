...
The PHP SDK for the Webflow API — an entity-oriented client using PHP conventions.
...
- Releases: [https://github.com/voxgig-sdk/webflow-sdk/releases](https://github.com/voxgig-sdk/webflow-sdk/releases)
...
```
php/
├── webflow_sdk.php          -- Main SDK class
...
The main class (`webflow_sdk.php`) exports the SDK class
