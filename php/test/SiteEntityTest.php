...
class SiteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEBFLOW_TEST_SITE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $site_ref01_data = null;
        if (count($site_ref01_data_raw) > 0) {
...
function site_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEBFLOW_TEST_SITE_ENTID");
