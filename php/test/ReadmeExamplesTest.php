...
// Webflow SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WebflowSDK::test)
...
{
    private const SDK_CLASS = 'WebflowSDK';
    ...
    private const SDK_BASE = 'webflow_sdk';
