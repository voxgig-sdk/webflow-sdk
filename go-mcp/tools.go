...
type Args struct {
	Entity string         `json:"entity" jsonschema:"collection | item | site"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WebflowSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "webflow_list",
		Description: "List records from Webflow. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "webflow_load",
		Description: "Load a single record from Webflow. " +
...
func runOp(client *sdk.WebflowSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WebflowSDK, name string) (sdk.WebflowEntity, error) {
