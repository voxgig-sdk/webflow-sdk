...
func registerSDKWords(r *eng.Registry, client *sdk.WebflowSDK) {
...
func runOp(client *sdk.WebflowSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
