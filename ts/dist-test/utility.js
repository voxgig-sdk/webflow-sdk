...
function envOverride(m) {
    if ('TRUE' === process.env.WEBFLOW_TEST_LIVE ||
        'TRUE' === process.env.WEBFLOW_TEST_OVERRIDE) {
    ...
    m.WEBFLOW_TEST_EXPLAIN = process.env.WEBFLOW_TEST_EXPLAIN || m.WEBFLOW_TEST_EXPLAIN;
    return m;
}
