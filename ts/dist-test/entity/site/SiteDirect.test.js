...
(0, node_test_1.describe)('SiteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-site', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-site', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-site', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-site', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WebflowSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
    ...
    const client = new __1.WebflowSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SiteDirect.test.js.map