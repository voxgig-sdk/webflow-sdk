...
|---|---|---|
| `js/` | @voxgig-sdk/webflow-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/webflow | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/webflow-js \
      --repository voxgig-sdk/webflow-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/webflow-js` shows it, and
`npm trust revoke @voxgig-sdk/webflow-js --id=<id>` removes it.
