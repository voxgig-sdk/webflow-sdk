...
// Webflow SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WebflowOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WebflowOmni::structfix($now, Struct::undef()))
                        !== json_encode(WebflowOmni::structfix($val, Struct::undef()))) {
