...
// Webflow SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WebflowTestFeature extends WebflowBaseFeature
{
    ...
    public function init(WebflowContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WebflowContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WebflowContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WebflowContext $ctx, $op, $args): array
    {
