...
// Webflow SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class WebflowParam
{
    public static function call(WebflowContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = WebflowHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
