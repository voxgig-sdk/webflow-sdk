...
class WebflowGraphql
{
    ...
    // equivalent.
    public static function body(WebflowContext $ctx): mixed
    {
    ...
    public static function errors(WebflowContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
