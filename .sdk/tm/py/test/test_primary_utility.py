...
from projectname_sdk import WebflowSDK
from projectname_sdk.core.spec import WebflowSpec
from projectname_sdk.core.result import WebflowResult
from projectname_sdk.core.response import WebflowResponse
from projectname_sdk.core.operation import WebflowOperation
from projectname_sdk.core.error import WebflowError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import WebflowBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = WebflowSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = WebflowSDK.test(None, None)
        ...
        class TestInitFeature(WebflowBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WebflowBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WebflowSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WebflowSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WebflowSDK.test(None, setup_opts)
